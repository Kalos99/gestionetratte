...
public class AirbusDTO {
	...
	public AirbusDTO(Long id, String codice, String descrizione, Date dataInizioServizio, Integer numeroPasseggeri, Set<TrattaDTO> tratte) {
		this.id = id;
		this.codice = codice;
	...
	public AirbusDTO(String codice, String descrizione, Date dataInizioServizio, Integer numeroPasseggeri, Set<TrattaDTO> tratte) {
		this.codice = codice;
		this.descrizione = descrizione;
		this.dataInizioServizio = dataInizioServizio;
		this.numeroPasseggeri = numeroPasseggeri;
	...
	public AirbusDTO(String codice, String descrizione, Date dataInizioServizio, Integer numeroPasseggeri) {
		this.codice = codice;
		this.descrizione = descrizione;
		this.dataInizioServizio = dataInizioServizio;
		this.numeroPasseggeri = numeroPasseggeri;
