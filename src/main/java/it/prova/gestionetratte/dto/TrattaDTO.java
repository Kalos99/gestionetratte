...
public class TrattaDTO {
	...
	public TrattaDTO(Long id, String codice, String descrizione, Date data, LocalTime oraDecollo, LocalTime oraAtterraggio, Stato stato, AirbusDTO airbus) {
		this.id = id;
		this.codice = codice;
	...
	public TrattaDTO(String codice, String descrizione, Date data, LocalTime oraDecollo, LocalTime oraAtterraggio, Stato stato, AirbusDTO airbus) {
		this.codice = codice;
		this.descrizione = descrizione;
		this.data = data;
		this.oraDecollo = oraDecollo;
	...
	public TrattaDTO(Long id, String codice, String descrizione, Date data, LocalTime oraDecollo, LocalTime oraAtterraggio, Stato stato) {
		this.id = id;
		this.codice = codice;
		this.descrizione = descrizione;
		this.data = data;
	...
	public TrattaDTO(String codice, String descrizione, Date data, LocalTime oraDecollo, LocalTime oraAtterraggio, Stato stato) {
		this.codice = codice;
		this.descrizione = descrizione;
		this.data = data;
		this.oraDecollo = oraDecollo;
